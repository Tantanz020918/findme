...
export const chats: Chat[] = [
  ...
  },
  {
    ...
    messages: [
      ...
      { id: 'b4', sender: 'me', content: '好呀❤️', time: '9月2日 13:07' },
      { id: 'b5', sender: 'me', content: '老公 我今天看到一个犯罪心理学的讲座 好想去听', time: '9月3日 19:50' },
      { id: 'b6', sender: 'other', content: '又是这些东西 你怎么还惦记着啊', time: '9月3日 19:55' },
      { id: 'b7', sender: 'me', content: '就是感兴趣嘛…我觉得我挺适合的', time: '9月3日 19:57' },
